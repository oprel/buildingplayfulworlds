    ...
    public class Button
    {
        ...
        public void Render()
        {
            ...
            if (mPressed)
            {
                ...
                {
                    FES.DrawRectFill(new Rect2i(mRect.x + 2, mRect.y + 2, mRect.width - 2, mRect.height - 2), DemoUtil.IndexToRGB(5));
                    FES.Print(new Vector2i(mRect.x + (mRect.width / 2) - (labelSize.width / 2) + 1, yPos + 1), DemoUtil.IndexToRGB(mLabelColor), mLabel);
                }
            }
            else
            {
                ...
                {
                    FES.DrawRectFill(mRect, DemoUtil.IndexToRGB(mFaceColor));
                    FES.Print(new Vector2i(mRect.x + (mRect.width / 2) - (labelSize.width / 2), yPos), DemoUtil.IndexToRGB(mLabelColor), mLabel);
                    FES.DrawRect(mRect, DemoUtil.IndexToRGB(5));
                }
            }
